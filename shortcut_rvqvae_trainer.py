...
class CustomTrainer(train.BaseTrainer):
    ...
    def __init__(self, args, cfg):
        ...
        if self.cfg.model.use_exp and self.cfg.model.use_face_pose:
    ...
    def _load_data(self, dict_data):
        ...
        # print(f"tar_pose_upper shape: {tar_pose_upper.shape}, tar_pose_hands shape: {tar_pose_hands.shape}, tar_pose_lower shape: {tar_pose_lower.shape}, tar_pose_face shape: {tar_pose_face.shape}")
        ...
        if self.cfg.model.use_exp and self.cfg.model.use_face_pose:
            ...
            vq_face_in = torch.cat([tar_pose_face, tar_exps], dim=-1)
            latent_face_top = self.vq_model_face.map2latent(vq_face_in)
    ...
    def _g_test(self, loaded_data):
        ...
        for i in range(0, roundt):
            ...
            if self.cfg.model.use_exp:
                ...
                # print(f"rec_latent_face:{rec_latent_face.shape}")
        ...
        if self.args.pose_norm:
            ...
            if self.cfg.model.use_exp:
                rec_pose_face = rec_face[...,:18] * self.std_face + self.mean_face if self.cfg.model.use_exp else None
