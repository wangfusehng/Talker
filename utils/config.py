...
def parse_args(config_path=None):
    ...
    parser.add("--vqvae_exp_path", default="", type=str)
    parser.add("--vqvae_face_path", default="", type=str)
...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    parser.add("--vq_norm", default=None, type=str)
    ...
    # print(f"Config file path: {args.cfg}")
