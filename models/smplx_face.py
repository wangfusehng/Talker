...
from .face_layers import *
from .base import TrainWrapperBaseClass
# from nets.spg.faceformer import Faceformer
from .s2g_face import Generator as s2g_face


from face_data_utils import get_mfcc_psf, get_mfcc_psf_min, get_mfcc_ta
import numpy as np
...
class TrainWrapper(TrainWrapperBaseClass):
    ...
    def init_params(self):
        ...
        self.each_dim = [eye_dim, body_dim, hand_dim, face_dim]
    ...
    def get_loss(self,
        ...
        # print(f"pred_poses shape: {pred_poses.shape}, gt_poses shape: {gt_poses.shape}")
        #pred_poses shape: torch.Size([1, 300, 103]), gt_poses shape: torch.Size([1, 300, 265])
